  ...
  <section className="text-gray-600 body-font">
      <div className="container px-5 py-8 md:py-16 mx-auto">
        ...
        <div className="flex flex-wrap -m-4">
          {/* {product.filter((obj) => obj.title.toLowerCase().includes(searchkey)).filter
...
{product.filter((obj) => 
    searchkey === '' || obj.title.toLowerCase().includes(searchkey.toLowerCase()) 
  )
  .filter((obj) => 
    ...
    const { title, price, description, imgURL, id } = item;
            ...
            >
              ...
              <div className="p-5 border-t-2">
                <h2
                  className="tracking-widest text-x title-font font-medium text-gray-400 mb-1"
                  style={{ color: mode === "dark" ? "white" : "" }}
                >
                  Trezo
                </h2>
                ...
                <div className=" flex justify-center">
                  <button   onClick={() => addCart(item)}
                    type="button"
                    className="focus:outline-none text-white bg-lightblue hover:bg-darkblue focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm w-full  py-2"
                  >
                    Add To Cart
                  </button>
                </div>
